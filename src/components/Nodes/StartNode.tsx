...
export const StartNode: React.FC<NodeProps<StartWorkflowNode>> = ({ id, data, selected }) => {
  ...
  return (
    <BaseNode id={id} type="start" title={data.title || 'Start'} icon={<PlayCircle size={15} />} selected={selected} accentColor="#10b981" accentBg="bg-emerald-50/80" validationError={getNodeError(id)}>
